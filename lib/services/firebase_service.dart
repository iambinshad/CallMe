import 'package:callme/firebase_options.dart';
...
class FirebaseService {
  ...
  static Future<bool> signUp(
    ...
    try {
      ...
      final UserModel user =
          UserModel(email: email, name: name, userName: userName);
      if (cred.user != null) {
  ...
  static Future<bool> login(
    ...
    try {
      ...
      if (cred.user != null) {
        final doc = await _store.collection('user').doc(cred.user!.uid).get();
        final data = doc.data();
        if (data != null) {
